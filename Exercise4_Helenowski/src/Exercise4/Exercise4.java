...
/*
 * I used the same test driver from the book but just added the option of returning the root of the BST, option 9, in the list of operations.
 * If you check the BinarySearchTree class, I returned the reference to the root, not the information contained in the object at the root, as
 * requested, or it returns null if the tree is empty, which is what the book specifies. 
 */
...
public class Exercise4
{
  public static void main(String[] args) 
  {
    ...
    while (keepGoing)
    {
      ...
      System.out.println("9: getRoot");
      System.out.println("10: stop Testing \n");
		...
		switch (operation)
      {
        ...
        case 9:
        	...
        	System.out.println("The info (obtained from the reference) of the root of the BST is: ");
        	System.out.println(tree.getRoot().getInfo());
        	System.out.println("The toString() method of the actual root returns: "); 
        	System.out.println(tree.getRoot());
        	}
        	else{
        	System.out.println("The tree is empty, therefore the root is a null pointer");
        	}
        	break;
		  
        case 10:  // stop testing
        keepGoing = false;
        break;
