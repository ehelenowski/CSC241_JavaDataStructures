...
public class BowlingGame {
	 ...
	 * a strike or a spare. Also increments the score appropriately and returns whether or not the frame is over.
	 */
	public boolean shot(int knocked){
		...
		else if (this.getFrame() == 10 && (shotNum == 2 || shotNum == 3) ) score += knocked;
	...
	//Getter for whether or not the current frame is over
