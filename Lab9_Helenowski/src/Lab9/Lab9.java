...
/*
 * 1A. One way to modify the program to keep track of the number of swaps used by each sort is to use an instance variable to hold the
 * number of swaps used by each type of sort. Each time the sort method is called, the swaps should be set back to zero so that it begins
 * counting from zero. Then you modify the swaps method to increment the number of swaps each time that the swaps method is called.This 
 * is the most simple implementation.
 * 
 * 1B. The implementation to track the number of swaps for each type of sort described above will be implemented in the code below.
 * 
 * 1C. The program is tested on selection sort, as the book requests.
 */
...
public class Lab9
{
  ...
  public static void main(String[] args)
  {
    ...
    printValues();
    System.out.println("values is sorted: " + isSorted());
    System.out.println("Swaps: "+swaps); //Should use 49 swaps
    System.out.println();
  }
}
